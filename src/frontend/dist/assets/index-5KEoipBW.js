...
function ApologyCardEditor({
  ...
  const [draft, setDraft] = reactExports.useState(card.body);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "article",
    {
      ...
      style: { animationDelay: `${index2 * 0.12}s` },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-accent/30 border-b border-border px-6 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs font-semibold tracking-widest uppercase text-muted-foreground mb-1", children: [
              "Apology ",
              card.index
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-semibold text-foreground leading-snug", children: card.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground mt-0.5 italic", children: card.subtitle })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-5", children: editing ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display italic text-foreground/80 text-sm", children: salutation }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                className: `absolute bottom-2 right-3 text-xs font-body ${draft.length >= MAX_CHARS ? "text-destructive" : "text-muted-foreground"}`,
                children: [
                  draft.length,
                  "/",
                  MAX_CHARS
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display italic text-foreground/80 text-sm", children: [
            card.closing,
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "not-italic font-body text-sm", children: signName })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display italic text-foreground/80 text-sm", children: salutation }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-foreground leading-relaxed whitespace-pre-wrap", children: card.body }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display italic text-foreground/80 text-sm", children: [
            card.closing,
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "not-italic font-body text-sm", children: signName })
        ...
        !editing && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
...
${signName}`
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-card border-b border-border shadow-soft sticky top-0 z-20 print:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 py-3 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-4 h-4 text-primary fill-primary/20" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg font-semibold text-foreground tracking-tight", children: "Sincere Notes" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                backgroundImage: "url('/assets/generated/apology-hero.dim_1200x500.jpg')"
              },
              "aria-hidden": "true"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-2xl mx-auto px-4 py-14 text-center animate-fade-in", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs font-semibold tracking-widest uppercase text-muted-foreground mb-4", children: "A sincere apology toolkit" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl sm:text-5xl font-bold text-foreground leading-tight mb-4 text-balance", children: [
              "A Hard-to-Find Way",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic font-medium", children: "to Say I'm Sorry." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-muted-foreground max-w-sm mx-auto leading-relaxed", children: "Find the words when yours aren't easy to find. Crafted with sincerity — customize each message for yourself." })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/40 border-b border-border print:bg-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto px-4 py-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "label",
        {
          htmlFor: "recipient-name",
          className: "font-display italic text-sm text-foreground/70 shrink-0",
          children: "Personalise with a name:"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
      ...
      recipientName && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-body text-xs text-muted-foreground italic animate-fade-in", children: [
        'Each card will address "',
        recipientName,
        '"'
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref: printRef,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden print:block mb-8 text-center border-b border-border pb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl font-bold text-foreground mb-2", children: "A Sincere Apology" }),
            recipientName && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-base text-muted-foreground", children: [
              "For ",
              recipientName
            ] })
          ] }),
          apologies.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            ApologyCardEditor,
            {
              card,
              recipientName,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: 'Click "Customize & Send" on any card to rewrite the message in your own voice.'
            }
          )
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border print:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 py-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs font-body text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic opacity-60", children: "Words matter. Yours do too." })
    ] }) }),
